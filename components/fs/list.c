...
void fs_list_init(struct list *list, int first_index) {
    // Create the mutex
...
int fs_list_add(struct list *list, void *item, int *item_index) {
...
int IRAM_ATTR fs_list_get(struct list *list, int index, void **item) {
...
int fs_list_remove(struct list *list, int index, int destroy) {
    struct list_index *cindex = NULL;
    int iindex;
...
int IRAM_ATTR fs_list_first(struct list *list) {
    int index;
    int res = -1;
...
int IRAM_ATTR fs_list_next(struct list *list, int index) {
    int res = -1;
    int iindex;
...
void fs_list_destroy(struct list *list, int items) {
    int index;
